...
public class Reserva {
    ...
    /**Este método calcula el coste total de la reserva
     * depende de los días reservados,
     * el tipo de habitación
     * y si necesitan o no cama supletoria
     * 
     * Si están más de 7 noches se les realiza un descuento del 10%
     */
